...
var getRandomStrict = function  (a, b) {
...
var addGoodsCardItems = function (picture) {
	...
	addCardTitles(goodsObject.name);
	...
	addCardPriceAndWeight (goodsObject.price, goodsObject.weight);
	...
	getRatingStars(goodsObject.rating.value);
	...
	addStarCounts(goodsObject.rating.number);
	...
	getSugarFacts(goodsObject.nutritionFacts.sugar);
	...
	addStarCounts(goodsObject.nutritionFacts.contents);


};
addGoodsCardItems(goodsObject.picture);
...
var addCardAddedItems = function () {
	...
	addOrderCardsTitle(goodsObject.name);
	...
	addCardOrderPrice(goodsObject.price);


	var newTemplate = document.querySelector ('.goods__cards');
	newTemplate.appendChild(cartAddedArray);
